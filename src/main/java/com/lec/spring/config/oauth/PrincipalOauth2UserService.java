...
public class PrincipalOauth2UserService extends DefaultOAuth2UserService {
    ...
    @Autowired
    private UserService userService; // 회원 조회, 가입용
...
//    private PasswordEncoder passwordEncoder;   // 회원 가입시 PW 인코딩
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        String username = provider + "_" + providerId;   // ex) "google_xxxx"
        ...
        if(user == null){  // 미가입자인 경우, 회원가입 진행
            ...
            if(cnt > 0){
                ...
                user = userService.findByUsername(username);   // 다시 읽어 온다. regDate 정보 등....
            } else {
                System.out.println("[OAuth2 인증. 회원 가입 성공]");
            }
